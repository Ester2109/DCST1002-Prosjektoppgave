  ...
  return (
    <Screen>
      ...
      <Paragraph>
        ...
        NTNU i Trondheim. I emnet cybersikkerhet i teamarbeid (DCST1002) har vi
      ...
      <Paragraph topSpacing={true}>
        I tilknytting til denne problemstillingen har vi valgt vernepliktige og
        ansatte i forsvaret som målgruppe. Vi har valgt å lage en interaktiv
        nettside som læringsobjekt, hvor enkeltman får informasjon tilknyttet
        posisjonsdeling
      </Paragraph>
    </Screen>
  );
